...
def do_build(cocos2d_root,ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode):
    ...
    if os.system(command) != 0:
        raise Exception("Build dynamic library for project [ " + app_android_root + " ] fails!")
    	  ...
    	  cocos2dlib_path = os.path.join(cocos2d_root, "/SimpleGLKitGame/cocos2d")

    	  command = '%s update lib-project -t %s -p %s' % (sdk_tool_path,android_platform,cocos2dlib_path,) 
    	  if os.system(command) != 0:
    	  	  raise Exception("update cpp lib-project [ " + cocos2dlib_path, + " ] fails!")  	  
...
def build(ndk_build_param,android_platform,build_mode):
    ...
    cocos2d_root = os.path.join(current_dir, "../cocos2d")
    ...
    do_build( cocos2d_root,, ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode)
